        ...
        <div class="back">
            ...
            <div class="main">
                <el-form :model="form" :inline="true" class="demo-form-inline">
                    ...
                    <el-form-item>
                        <el-col :span="11">
                            <el-date-picker type="date" placeholder="申请起始时间" value-format="yyyy-MM-dd" @change="dateChangeStart" v-model="form.applytimestart"></el-date-picker>
                        </el-col>
                    </el-form-item>
                    <el-form-item class="single">
                        <el-col :span="11">
                            <el-date-picker type="date" placeholder="申请结束时间" value-format="yyyy-MM-dd" @change="dateChangeEnd" v-model="form.applytimeend"></el-date-picker>
                        </el-col>
                    </el-form-item>
                    <el-form-item>
                    ...
                    <el-table-column :resizable='false' label="审核操作" align="center" width="200">
                        <template slot-scope="scope">
                            <el-popover :ref="`popover+${scope.$index}`" placement="bottom-end" width="200" trigger="click">
                                ...
                                <el-button type="warning" size="mini" slot="reference" style="width: 60px;">通过</el-button>
                            </el-popover>
                            <el-popover :ref="`popover-${scope.$index}`" placement="bottom-end" width="200" trigger="click">
    ...
    export default {
        ...
        methods: {
            ...
            downloadSource() {
                ...
                that.downloadExcel("/order/exportpeople.do",param,'待人审订单报表');
            },
            Search() {
                var that = this;
                if (!!that.form.phone && that.form.phone.length != 11) {
