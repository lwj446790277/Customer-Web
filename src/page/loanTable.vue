        ...
        <div class="back">
            ...
            <div class="main">
                ...
                <el-table border :data="tableData" tooltip-effect="dark" style="width: 100%;line-height: 60px;">
                    <el-table-column :resizable='false' prop="applynumber" label="放款时间" align="center" width="130"></el-table-column>
                    <el-table-column :resizable='false' prop="applytime" label="总计放款金额" align="center" width='180'></el-table-column>
                    <el-table-column :resizable='false' prop="name" label="总计放款人数" align="center" width="80"></el-table-column>
                    <el-table-column :resizable='false' prop="phone" label="新客放款金额" align="center" width="120"></el-table-column>
                    <el-table-column :resizable='false' prop="stateName" label="新客放款人数" align="center" width="70"></el-table-column>
                    <el-table-column :resizable='false' prop="sourcename" label="老客放款金额" align="center" width='90'></el-table-column>
                    <el-table-column :resizable='false' prop="registeclient" label="老客放款人数" align="center" width='90'></el-table-column>
                    <el-table-column :resizable='false' prop="canBorrowLines" label="已还人数(复借率)" align="center" width="130"></el-table-column>
                    <el-table-column :resizable='false' prop="rmModleName" label="当天通过人数" align="center" width='80'></el-table-column>
                    <el-table-column :resizable='false' prop="riskControlPoints" label="当天借款率" align="center" width='80'></el-table-column>
                    <el-table-column :resizable='false' prop="shareOfStateName" label="老客复借占比" align="center" width='110'></el-table-column>
                </el-table>
                <div class="block">
