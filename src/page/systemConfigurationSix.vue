        ...
        <div class="back">
            ...
            <div class="main">
                ...
                <el-table border :data="tableData" style="width: 50%;line-height: 60px;">
                    <el-table-column :resizable='false' prop="grade" label="逾期等级" align="center"></el-table-column>
                    <el-table-column :resizable='false' prop="describes" label="逾期时间段" align="center"></el-table-column>
                </el-table>
                <br/>
                ...
                <el-dialog title="逾期等级编辑" :visible.sync="editLoanDialogVisible">
                    <el-table border :data="detailTableData">
                        <el-table-column :resizable='false' prop="grade" label="逾期等级" align="center">
                            <template scope="scope">
                                <el-input v-model="scope.row.grade" placeholder="请输入逾期等级"></el-input>
                            </template>
                        </el-table-column>
                        <el-table-column :resizable='false' prop="describes" label="逾期时间段" align="center">
                            <template scope="scope">
