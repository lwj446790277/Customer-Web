        ...
        <div class="back">
            ...
            <div class="main">
                <el-form :model="form" :inline="true" class="demo-form-inline">
                    ...
                    <el-form-item>
                        <el-select placeholder="请选择客户范围" v-model="form.user">
                ...
                <el-table border :data="tableData" tooltip-effect="dark" style="width: 100%;line-height: 60px;">
                    <el-table-column :resizable='false' prop="applynumber" label="应还日期" align="center" width="130"></el-table-column>
                    <el-table-column :resizable='false' prop="applytime" label="应还账单数" align="center" width='180'></el-table-column>
                    <el-table-column :resizable='false' prop="name" label="在逾率/个数" align="center" width="80"></el-table-column>
                    <el-table-column :resizable='false' prop="phone" label="首逾率/个数" align="center" width="120"></el-table-column>
                    <el-table-column :resizable='false' prop="stateName" label="d3率/个数" align="center" width="70"></el-table-column>
                    <el-table-column :resizable='false' prop="sourcename" label="d5率/个数" align="center" width='90'></el-table-column>
                    <el-table-column :resizable='false' prop="registeclient" label="d7率/个数" align="center" width='90'></el-table-column>
                    <el-table-column :resizable='false' prop="canBorrowLines" label="d15率/个数" align="center" width="130"></el-table-column>
                </el-table>
                <div class="block">
