        ...
        <div class="back">
            ...
            <div class="main">
                ...
                <el-table border :data="tableData" tooltip-effect="dark" style="width: 100%;line-height: 60px;">
                    <el-table-column :resizable='false' prop="applynumber" label="还款时间" align="center" width="130"></el-table-column>
                    <el-table-column :resizable='false' prop="applytime" label="已还款金额(笔数)" align="center" width='180'></el-table-column>
                    <el-table-column :resizable='false' prop="name" label="未还款金额(笔数)" align="center" width="80"></el-table-column>
                    <el-table-column :resizable='false' prop="phone" label="新客还款金额(笔数)" align="center" width="120"></el-table-column>
                    <el-table-column :resizable='false' prop="stateName" label="新客未还款金额(笔数)" align="center" width="70"></el-table-column>
                    <el-table-column :resizable='false' prop="sourcename" label="新客还款率(金额)" align="center" width='90'></el-table-column>
                    <el-table-column :resizable='false' prop="registeclient" label="新客还款率(笔数)" align="center" width='90'></el-table-column>
                    <el-table-column :resizable='false' prop="canBorrowLines" label="老客还款金额(笔数)" align="center" width="130"></el-table-column>
                    <el-table-column :resizable='false' prop="rmModleName" label="老客未还款金额(笔数)" align="center" width='80'></el-table-column>
                    <el-table-column :resizable='false' prop="riskControlPoints" label="老客还款率(金额)" align="center" width='80'></el-table-column>
                    <el-table-column :resizable='false' prop="shareOfStateName" label="老客还款率(笔数)" align="center" width='110'></el-table-column>
                    <el-table-column :resizable='false' prop="shareOfStateName" label="总计应还金额(笔数)" align="center" width='110'></el-table-column>
                    <el-table-column :resizable='false' prop="shareOfStateName" label="还款率(金额)" align="center" width='110'></el-table-column>
                    <el-table-column :resizable='false' prop="shareOfStateName" label="还款率(笔数)" align="center" width='110'></el-table-column>
                    <el-table-column :resizable='false' prop="shareOfStateName" label="当日还款率" align="center" width='110'></el-table-column>
                    <el-table-column :resizable='false' prop="shareOfStateName" label="催后还款率" align="center" width='110'></el-table-column>
                </el-table>
                <div class="block">
