                        ...
                        <div class="main">
                            <table cellpadding="40" cellspacing="0" class="tab-two">
                                <tr>
                                    <th>当天已放款金额</th>
                                    <td>
                                        <input autocomplete="off" type="text" rows="2" validateevent="true" class="el-input__inner nmsl" v-model="loantoday"
...
<script>
    ...
    export default {
        ...
        created() {
            if (this.isInArray(64)) {
                this.Search();
            }
            if (this.isInArray(65)) {
                this.Search2();
            }
        },
