        ...
        <div class="back">
            ...
            <div class="main">
                ...
                <el-table border :data="tableData" style="width: 100%">
                    <el-table-column :resizable='false' prop="remittanceTime" label="流水号时间" align="center"></el-table-column>
                    <el-table-column :resizable='false' prop="sourceName" label="放款渠道" align="center"></el-table-column>
                    <el-table-column :resizable='false' prop="pipelinenumber" label="放款流水号" align="center"></el-table-column>
                    <el-table-column :resizable='false' prop="bank" label="开户行" align="center"></el-table-column>
                    <el-table-column :resizable='false' prop="borrowRepayBankcard" label="银行卡号" align="center"></el-table-column>
                    <el-table-column :resizable='false' prop="paymentmoney" label="放款金额" align="center"></el-table-column>
                    ...
                    <el-table-column :resizable='false' prop="address" label="订单查询" align="center">
                        <template slot-scope="scope">
                            <span class="blue" @click="jie(scope.row.orderId)">借款信息</span>
                        </template>
                    </el-table-column>
                </el-table>
                <el-dialog title="借款信息" :visible.sync="centerDialogVisible" width="30%" customClass="custom" center>
    ...
    export default {
        ...
        methods: {
            ...
            downloadSource() {
                ...
                that.downloadExcel("/fina/Allpayment_recordexport", param, '放款实时流水');
            },
            Search() {
                if (!!this.form.phone && this.form.phone.length != 11) {
                    this.$message({
            ...
            jie(orderId) {
                ...
                this.axios.get("fina/PaymentOrder", {
                    ...
                    this.money = res.data.Orderdetails.defeMoney; //延期金额
