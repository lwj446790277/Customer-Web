  ...
  <div class="fillcontain">
    ...
    <el-tabs v-model="activeName" type="card">
      <el-tab-pane label="借款设置" name="first">
        ...
        <el-dialog
          :title="title"
          :visible.sync="editLoanDialogVisible"
        ...
        >
          <table border="0" cellpadding="25" cellspacing="0" class="tables">
            ...
            <tr>
              <th>日均利息</th>
              <td>
                <el-input placeholder="保留四位小数" v-model="jiekuanEditObject.averagedailyinterest"></el-input>
                <span>%</span>
              </td>
            </tr>
            <tr>
              <th>平台服务费比率</th>
              <td>
                <el-input placeholder="输入1-50的整数" v-model="jiekuanEditObject.platformfeeratio"></el-input>
                <span>%</span>
              </td>
            </tr>
          </table>
      ...
      <el-tab-pane label="延期设置" name="second">
        ...
        <el-dialog
          title="编辑延期设置"
          :visible.sync="editDeferredVisibles"
          customClass="customWidth"
          width="30%"
          center
        >
...
export default {
  ...
  methods: {
    openEditLoanDialog() {
      ...
      that.jiekuanEditObject.averagedailyinterest =
        that.jiekuanObject.averagedailyinterest;
      that.jiekuanEditObject.platformfeeratio =
        that.jiekuanObject.platformfeeratio;
    ...
    loanEdit() {
      var that = this;
      that.axios
        .get("/borrowmonmes/updateByPrimaryKey", {
    ...
    saveDeferredSetting() {
      var that = this;
      that.axios
        .get("/deferredset/updateByPrimaryKey", {
    ...
    saveHowmanydaysapart() {
      var that = this;
      that.axios
        .get("/retrialwincon/updateByPrimaryKey", {
          params: {
    ...
    deleteLine(index, object) {
      ...
      if (!!object.id) {
        that.axios
          .get("/liftingamount/updateByPrimaryKey", {
            params: { id: object.id }
          })
          .then(res => {
            this.$message({
