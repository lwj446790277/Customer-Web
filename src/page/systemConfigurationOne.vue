                    ...
                    <div class="main">
                        ...
                        <el-dialog title="逾期设置编辑" :visible.sync="page3DialogVisible">
                            <el-table border :data="detailTable3Data">
                                <el-table-column label="逾期第X天前" align="center">
                                    <template scope="scope">
                                        <el-input type="number" v-model="scope.row.overduehowmanydaysage"
                                                  placeholder="请输入逾期天数"></el-input>
                                    </template>
                                </el-table-column>
                                <el-table-column label="罚息利率" align="center">
                                    <template scope="scope">
                                        <el-input v-model="scope.row.penaltyinterestrates"
                                                  placeholder="请输入罚息利率"></el-input>
                                        %
                                    </template>
                                </el-table-column>
                                <el-table-column prop="address" label="操作" align="center">
                                    <template slot-scope="scope">
                                        <el-button type="primary" @click="saveLine3(scope.$index,scope.row)">保存
                                        </el-button>
                                        <el-button type="danger" @click="deleteLine3(scope.$index,scope.row)">删除
                                        </el-button>
                                    </template>
                                </el-table-column>
                            </el-table>
